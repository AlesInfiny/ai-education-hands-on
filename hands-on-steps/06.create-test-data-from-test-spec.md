...
1. GitHub Copilot に次の質問をします。
    ...
    ```plaintext
    #file:designdoc-main.md および #file:testspec-main.md をインプットとし、 #file:test-data-template.md に基づいて、テストデータを作成してください。なお、 #file:test-specification-main.md に定義されたすべてのテストケースについて、テストデータを作成してください。
    ```
...
### テストケースID: CALC_SALARY_002

| EMPLOYEE-ID | EMPLOYEE-NAME   | DEPARTMENT | GROSS-SALARY |
| ----------- | --------------- | ---------- | ------------ |
| E001        | Alice Johnson   | HR         | 70000.00     |

### テストケースID: CALC_SALARY_003

| EMPLOYEE-ID | EMPLOYEE-NAME   | DEPARTMENT | GROSS-SALARY |
| ----------- | --------------- | ---------- | ------------ |
| E001        | Alice Johnson   | HR         | 70000.00     |

### テストケースID: CALC_SALARY_004

| EMPLOYEE-ID | EMPLOYEE-NAME   | DEPARTMENT | GROSS-SALARY |
| ----------- | --------------- | ---------- | ------------ |
| E001        | Alice Johnson   | HR         | 70000.00     |

### テストケースID: CALC_SALARY_005

| EMPLOYEE-ID | EMPLOYEE-NAME   | DEPARTMENT | GROSS-SALARY |
| ----------- | --------------- | ---------- | ------------ |
| E002        | Bob Smith       | IT         | 85000.00     |

### テストケースID: DEPT_TOTAL_001

使用データセット： TestDataSet1

### テストケースID: DEPT_TOTAL_002
...
### テストケースID: DISP_EMP_001

使用データセット： TestDataSet1

### テストケースID: DISP_DEPT_001
